  ...
  main.innerHTML = `
    ...
    <div style="display:flex;justify-content:flex-end;align-items:center;margin-bottom:16px">
      <div style="display:flex;gap:10px">
        ...
        <button onclick="toggleSourceOz('${c.id}', ${!c.source_oz})" title="${c.source_oz ? 'Client OZ Assure — cliquer pour retirer' : 'Marquer comme client OZ Assure'}" style="background:${c.source_oz ? 'rgba(74,144,226,0.15)' : 'var(--surface)'};border:1px solid ${c.source_oz ? 'rgba(74,144,226,0.4)' : 'var(--border)'};border-radius:8px;padding:7px 12px;cursor:pointer;display:flex;align-items:center;gap:5px;font-size:12px;color:${c.source_oz ? '#4a90e2' : 'var(--text-muted)'};font-weight:700">${c.source_oz ? OZASSURE_LOGO_SVG.replace('class="oz-logo-svg"', 'style="height:16px;width:auto"') + ' Client OZ' : '+ Marquer OZ'}</button>
