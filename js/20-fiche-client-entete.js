...
function htmlEnteteFicheClient(c, ctx) {
  ...
  <section class="fcx-hero">
    ...
    <div class="fcx-hero-bas">
      ...
      <button type="button" class="fcx-badge ${c.source_oz ? 'on' : ''}" onclick="toggleSourceOz('${c.id}', ${!c.source_oz})" title="${c.source_oz ? 'Client OZ Assure — cliquer pour retirer' : 'Marquer comme client OZ Assure'}">${c.source_oz ? '✓ OZ Assure' : '+ OZ'}</button>
