      ...
      return `<div class="table-row" style="grid-template-columns:${cols};align-items:center">
        ...
        <div style="display:flex;gap:6px;flex-wrap:wrap">
          ${a.besoins.map(b => {
            ...
            if (b.couvert) return `<span title="${eqEsc(b.label)}${b.viaFamille ? ' (via les parents)' : ''}" style="font-size:11px;padding:3px 8px;border-radius:999px;background:rgba(74,222,128,0.12);color:var(--c-succes-texte);border:1px solid rgba(74,222,128,0.3)">✓ ${b.court}</span>`;
