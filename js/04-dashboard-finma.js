...
// (retiré le 22.09.2026) viewVolumePrimes : doublon mort — la version active est dans js/30, chargée après celle-ci, donc seule exécutée.
...
// (retiré le 22.09.2026) renderTopClientsCompagnie : doublon mort — la version active est dans js/30, chargée après celle-ci, donc seule exécutée.
...
// (retiré le 22.09.2026) renderVolumePrimesCorps : doublon mort — la version active est dans js/30, chargée après celle-ci, donc seule exécutée.
