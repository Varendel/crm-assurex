...
function updateModulesOptions() {
  ...
  // et ses options LAA/LAAC/IJM/LPP, voir CATALOGUE_PRODUITS_PAR_COMPAGNIE), on propose CELLE-LÀ
  ...
  const modulesCie = (produit && !estSante && typeof produitsPourCompagnie === 'function')
    ? produitsPourCompagnie(document.getElementById('ct-compagnie')?.value || '', produit.id)
    : null;
